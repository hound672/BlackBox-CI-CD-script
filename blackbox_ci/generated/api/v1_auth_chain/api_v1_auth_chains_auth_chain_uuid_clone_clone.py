...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        'method': 'post',
        'url': '/api/v1/auth-chains/{auth_chain_uuid}/clone'.format(
            auth_chain_uuid=quote(str(auth_chain_uuid), safe='')
        ),
    }
...
) -> AuthChainShortInfoSchema | ErrorSchemaNoneType | ErrorSchemaRoleAttributeDescriptionSchema | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AuthChainShortInfoSchema | ErrorSchemaNoneType | ErrorSchemaRoleAttributeDescriptionSchema]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        AuthChainShortInfoSchema | ErrorSchemaNoneType | ErrorSchemaRoleAttributeDescriptionSchema
    """
