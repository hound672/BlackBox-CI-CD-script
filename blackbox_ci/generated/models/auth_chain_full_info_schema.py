...
T = TypeVar('T', bound='AuthChainFullInfoSchema')


@_attrs_define
class AuthChainFullInfoSchema:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for profiles_item_data in self.profiles:
            profiles_item = str(profiles_item_data)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for profiles_item_data in _profiles:
            profiles_item = UUID(profiles_item_data)

            profiles.append(profiles_item)

        uuid = UUID(d.pop('uuid'))

        auth_chain_full_info_schema = cls(
            group=group,
            name=name,
            profiles=profiles,
            uuid=uuid,
        ...
        auth_chain_full_info_schema.additional_properties = d
        return auth_chain_full_info_schema
