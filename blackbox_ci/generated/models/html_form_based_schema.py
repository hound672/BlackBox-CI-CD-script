...
T = TypeVar('T', bound='HTMLFormBasedSchema')


@_attrs_define
class HTMLFormBasedSchema:
    """
    Attributes:
        form_url (str):
        form_x_path (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        password_value = d.pop('passwordValue')
        ...
        html_form_based_schema.additional_properties = d
        return html_form_based_schema
