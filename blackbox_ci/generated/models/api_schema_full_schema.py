...
if TYPE_CHECKING:
    from ..models.api_schema_full_content_schema import APISchemaFullContentSchema
...
T = TypeVar('T', bound='APISchemaFullSchema')


@_attrs_define
class APISchemaFullSchema:
    """
    Attributes:
        content (APISchemaFullContentSchema):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        content = APISchemaFullContentSchema.from_dict(d.pop('content'))
        ...
        api_schema_full_schema.additional_properties = d
        return api_schema_full_schema
