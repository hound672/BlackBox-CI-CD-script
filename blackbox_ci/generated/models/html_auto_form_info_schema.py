...
T = TypeVar('T', bound='HTMLAutoFormInfoSchema')


@_attrs_define
class HTMLAutoFormInfoSchema:
    """
    Attributes:
        form_url (str):
        success_string (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        html_auto_form_info_schema = cls(
            form_url=form_url,
        ...
        html_auto_form_info_schema.additional_properties = d
        return html_auto_form_info_schema
